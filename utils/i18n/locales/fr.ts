...
export const fr = {
  ...
  session: {
    eyebrow: 'LE RITUEL DE CE SOIR',
    introTitle: 'Trois gestes',
    minutes: 'minutes',
    atYourPace: 'à ton rythme',
    begin: 'Commencer',
    later: 'Plus tard',
    stepOf: 'ÉTAPE {i} / {n}',
    stepDone: 'Étape terminée',
    skipStep: 'Passer cette étape',
    doneTitle: 'Rituel accompli',
    doneBody: 'Ta peau a reçu ce dont elle avait besoin ce soir. Repose-toi — la constance fait le reste.',
    luneNote: 'ta semaine s\'illumine',
    finish: 'Terminer',
  },
  routine: {
    title: 'Ma Routine',
    ...
    addModal: {
      ...
      searchPlaceholder: 'Chercher ou nommer un produit',
      fromProducts: 'Depuis mes produits',

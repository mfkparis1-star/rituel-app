...
export const en: LocaleDict = {
  ...
  home: {
    ...
    tonight: {
      ...
      adapted: {
        glowing: 'Glowing — keep your ritual as it is',
        good: 'Good day — your usual ritual',
        neutral: 'Neutral day — the essentials are enough',
        tired: 'Tired — lighter tonight, no actives',
        rough: 'Rough day — gentle care only tonight',
      },
      noCheckin: 'Do your check-in to adapt this ritual',
      start: 'Begin · {n} min',
      continueOne: 'Continue · 1 step left',
      continueMany: 'Continue · {n} steps left',
      doneTitle: 'Done for tonight',
      doneBody: 'Your skin thanks you. See you tomorrow.',
      emptyTitle: 'Your evening ritual awaits',
      emptyBody: 'Three simple steps are enough to begin.',
      emptyCta: 'Create my ritual',
    },
    lune: { label: 'This week · Lune' },
    weekStrip: { days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] },
    aphorisms: [
      'Caring for yourself is the most elegant of promises.',
      'Your skin listens to what you whisper to it each night.',
      'Consistency is the gentlest of secrets.',
      'Tonight, three minutes just for you.',
      'Beauty loves slowness.',
      'Every gesture counts, even the smallest.',
      'Your ritual, your moment.',
    ],
  ...
  session: {
    ...
    doneBody: 'Your skin received what it needed tonight. Rest — consistency does the rest.',
    luneNote: 'your week brightens',
    finish: 'Finish',
  },
  routine: {
    title: 'My Routine',
    ...
    addModal: {
      ...
      title: 'New step',
      searchPlaceholder: 'Search or name a product',
      fromProducts: 'From my products',
  ...
  makeup: {
    hero: {
      ...
      title: 'Find your perfect makeup',
      ctaContinue: 'Continue',
      ctaChoose: 'Choose an occasion',
    },
    occasionSection: 'Choose the occasion',
    continueBtn: 'Continue',
    howItWorks: 'How it works',
    features: {
      0: { label: 'ARCHIVE', title: 'Use your archive', description: 'AI suggests looks from your own products.' },
      1: { label: 'COMPLETE', title: 'Missing products', description: 'Discover what you need to create the look.' },
      2: { label: 'PERSONALIZED', title: 'Matched to the occasion', description: 'Every suggestion fits your occasion.' },
    },
    selfie: {
      title: 'Add a selfie',
      remove: 'Remove',
      generate: 'Generate my looks',
      skip: 'Continue without a selfie',
    },
    ...
    alerts: {
      ...
      addSelfieTitle: 'Add a selfie',
      addSelfieBody: 'Choose how you want to add your photo.',
